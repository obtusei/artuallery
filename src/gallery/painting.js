...
export default function painting(regl) {
  ...
  return function (batch) {
    const cardData = {
      title: "Artwork Title",
      description:
        "This is a brief description of the artwork. Click read more for details.",
      fullDetails:
        "This is the full detailed information about the artwork. It can include the artist's name, creation date, medium used, and any other relevant information about the piece.",
    };

    // Create the card texture
    // const cardTexture = info.init(regl.texture, cardData);

    // Update the batch object with card texture
    // const batchWithCard = {
    //   ...batch,
    //   text: cardTexture,
    //   textmodel: batch.model, // Use same model matrix for card
    // };
